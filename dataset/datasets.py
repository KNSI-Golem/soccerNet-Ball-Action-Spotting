...
def get_datasets(args):
    if args.event_team:
        classes = load_classes(os.path.join('data', 'raw', args.dataset, 'class.txt'), event_team = True)
    else:
        classes = load_classes(os.path.join('data', 'raw', args.dataset, 'class.txt'))
    ...
    train_data = ActionSpotDataset(
        classes, os.path.join('data', 'raw', args.dataset, 'train.json'),
    ...
    val_data = ActionSpotDataset(
        classes, os.path.join('data', 'raw', args.dataset, 'val.json'),
        args.frame_dir, args.store_dir, args.store_mode,
    ...
    if args.joint_train != None:
        ...
        if args.event_team:
            joint_train_classes = load_classes(os.path.join('data', 'raw', args.joint_train['dataset'], 'class.txt'), event_team = True)
        else:
            joint_train_classes = load_classes(os.path.join('data', 'raw', args.joint_train['dataset'], 'class.txt'))
        

        joint_train_train_data = ActionSpotDataset(
            joint_train_classes, os.path.join('data', 'raw', args.joint_train['dataset'], 'train.json'),
        ...
        joint_train_val_data = ActionSpotDataset(
            joint_train_classes, os.path.join('data', 'raw', args.joint_train['dataset'], 'val.json'),
            args.joint_train['frame_dir'], args.joint_train['store_dir'], args.store_mode,
